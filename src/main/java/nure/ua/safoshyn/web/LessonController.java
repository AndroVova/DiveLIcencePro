...
public class LessonController {
    ...
    @PutMapping("/{id}/user/{user_id}/instructor/{instructor_id}")
    public ResponseEntity<Lesson> saveLesson(@PathVariable Long id, @PathVariable Long user_id, @PathVariable Long instructor_id) {
